CREATE TYPE "public"."restaurant_type" AS ENUM('veg', 'non-veg', 'both');--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('customer', 'restaurant_owner');--> statement-breakpoint
